...
// Fun‡Æo para cadastrar um operador no sistema
...
// Fun‡Æo para pesquisar um operador pelo usuÃ¡rio
int pesquisarOperadorPorUsuario(int mode, char pqusuario[20], str_op_sistemas *operador) {
    ...
    fclose(foperador);
    return 1;  // Operador nÆo encontrado
}

// Fun‡Æo para editar um operador
...
// Fun‡Æo para excluir um operador
